      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold">
                {language === "en" ? "NCTB Science Simulator" : "এনসিটিবি বিজ্ঞান সিমুলেটর"}
              </h3>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-white/60">
          <p>
            © {currentYear}{" "}
            {language === "en"
              ? "NCTB Science Simulator. All rights reserved. Built by a Class 9 student."
              : "এনসিটিবি বিজ্ঞান সিমুলেটর। সর্বাধিকার সংরক্ষিত। একজন নবম শ্রেণীর শিক্ষার্থীর দ্বারা নির্মিত।"}
          </p>
